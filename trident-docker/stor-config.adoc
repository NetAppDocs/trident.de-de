...
Weitere Informationen zu FlexGroups und Arbeitslasten, die für FlexGroups geeignet sind, finden Sie im  https://www.netapp.com/pdf.html?item=/media/12385-tr4571.pdf["Best Practices und Implementierungsleitfaden für NetApp FlexGroup Volumes"^].
