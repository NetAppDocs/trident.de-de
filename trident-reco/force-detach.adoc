...
NOTE: Sie können auch alternative Methoden zur Erkennung von Knotenausfällen verwenden, wie im <<Integration kundenspezifischer Lösungen zur Überprüfung des Knotenzustands>> Abschnitt unten angegeben.
