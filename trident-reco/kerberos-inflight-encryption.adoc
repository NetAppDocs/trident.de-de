...
* *On-premise ONTAP* - Trident unterstützt Kerberos-Verschlüsselung über NFSv3 und Verbindungen von Red Hat OpenShift und Upstream-Kubernetes-Clustern zu On-premise ONTAP Volumes.
...
* Stellen Sie sicher, dass alle Volumes, die Sie mit Kerberos-Verschlüsselung verwenden, korrekt konfiguriert sind. Siehe den Abschnitt NetApp Domain Configuration (Seite 13) des  https://www.netapp.com/media/16398-tr-3580.pdf["NetApp Enhancements und Best Practices-Leitfaden"^].
...
.Zugriffsprotokolle
Konfigurieren Sie die Exportrichtlinie mit NFS, NFSv3 und Zugriffsprotokollen.
