...
[role="lead"]
Wenn Sie Trident 25.06 nicht verwenden, ist die Dokumentation für frühere Versionen auf Basis der verfügbarlink:get-help.html["Lebenszyklus des Trident Supports"].
