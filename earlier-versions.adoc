...
[role="lead"]
Falls Sie nicht Trident 26.02 verwenden, ist die Dokumentation für frühere Versionen basierend auf der link:get-help.html["Lebenszyklus des Trident Supports"] verfügbar.
