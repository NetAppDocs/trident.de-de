...
[role="lead"]
Falls Sie nicht Trident 26.06 verwenden, ist die Dokumentation für frühere Versionen basierend auf der link:get-help.html["Lebenszyklus des Trident Supports"] verfügbar.
