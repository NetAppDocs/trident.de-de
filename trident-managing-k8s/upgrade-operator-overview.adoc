...
TIP: Weitere Informationen zur Trident-Architektur auf dem Kubernetes-Cluster finden Sie unter link:trident-concepts/intro.html#trident-architecture["Architektur von Trident"].
