...
[role="lead"]
Während link:../trident-managing-k8s/tridentctl.html["Tridentctl-Befehle und -Optionen"] die einfachste Möglichkeit sind, mit der Trident REST API zu interagieren, können Sie den REST-Endpunkt auch direkt verwenden, wenn Sie dies bevorzugen.
