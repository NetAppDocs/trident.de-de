...
| TCP/UDP 111 | Ausgehend | RPCBIND/portmapper | ONTAP-NAS (NFSv3/v4), ANF (NFS) | Erforderlich für v3; optional für v4 (firewall offload); einschränken, wenn -only verwendet wird. 
