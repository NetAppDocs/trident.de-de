...
| Version | Ende der vollständigen Unterstützung | Ende der eingeschränkten Unterstützung | Ende des Self-Support 


 a| 
link:https://docs.netapp.com/us-en/trident/index.html["26,06"^]
| Juli 2027 | Juli 2028 | Juli 2029 


 a| 
link:https://docs.netapp.com/us-en/trident/index.html["26,02"^]
| Februar 2027 | Februar 2028 | Februar 2029 
...
Eine vollständige Liste der Artikel zur Fehlerbehebung finden Sie unter https://kb.netapp.com/Advice_and_Troubleshooting/Cloud_Services/Trident_Kubernetes["NetApp Knowledge Base (Anmeldung erforderlich)"^].
