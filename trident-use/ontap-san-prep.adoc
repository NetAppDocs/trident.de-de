...
NOTE: link:https://docs.netapp.com/us-en/asa-r2/get-started/learn-about.html["ASA R2-Systeme"^] unterscheiden sich von anderen ONTAP-Systemen (ASA, AFF und FAS) in der Implementierung ihrer Speicherschicht. In ASA r2-Systemen werden Storage Availability Zones anstelle von Aggregaten verwendet. Siehe link:https://kb.netapp.com/on-prem/ASAr2/ASAr2_KBs/su_create_by_SVM_admin_using_CLI_fails_with_error_No_candidate_aggregates_are_available_for_storage_services["Das"^] Knowledge Base-Artikel zum Zuweisen von Aggregaten zu SVMs in ASA R2-Systemen.
...
=== Anmeldeinformationsbasierte Authentifizierung aktivieren
...
=== Authentifizierungsmethoden aktualisieren oder Anmeldeinformationen rotieren
