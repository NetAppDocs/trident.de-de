...
Ab Version 25.02 erkennt Trident automatisch ASA r2-Persönlichkeit des ONTAP 9.16.1 oder höher und ermöglicht die Bereitstellung und Nutzung von Storage auf ASA r2 über das iSCSI-Protokoll.
...
NOTE: Für Trident muss der SVM mindestens ein Aggregat zugewiesen sein. Bei Verwendung von ASA r2 ist diese Aktion nur mit der ONTAP-CLI im Modus verfügbar `diag`.
