...
| `maxThroughput` | Legt den maximal zulässigen Durchsatz in MiB/s fest. Wird nur für manuelle QoS-Kapazitätspools unterstützt. *Technische Vorschau für Trident 25.06* | `4 MiB/sec` 
|===
