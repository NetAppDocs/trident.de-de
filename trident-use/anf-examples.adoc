...
== Berücksichtigen Sie Azure-Cloud-Umgebungen (26.06)

Ab der Version 26.06 unterstützt Trident das Erstellen und Verwalten von Azure NetApp Files-Backends in mehreren Azure-Cloud-Umgebungen.
...
| `snapshotDir` | Zugriff auf die `.snapshot` Verzeichnis | `true`, `false` (explizit festlegen). 
