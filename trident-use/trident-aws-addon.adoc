...
. Suchen Sie *AstraTrident by NetApp* und aktivieren Sie das Kontrollkästchen für das Trident-Add-on.
...
Die folgenden Beispielbefehle installieren das Trident EKS Add-On:
