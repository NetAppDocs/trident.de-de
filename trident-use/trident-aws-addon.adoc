...
----
. Fahren Sie mit der Einrichtung fort und konfigurieren Sie das Storage-Backend. Weitere Informationen finden Sie unter link:trident-fsx-storage-backend.html["Konfigurieren Sie das Speicher-Back-End"].
