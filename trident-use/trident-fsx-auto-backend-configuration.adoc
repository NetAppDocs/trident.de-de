...
Eine vollständige Liste der Backend-Parameter finden Sie unter: link:trident-fsx-storage-backend.html#backend-advanced-configuration-and-examples["FSx für NetApp ONTAP Backend-Konfiguration"].
