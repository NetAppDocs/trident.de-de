...
| `credentialsName` | Ja. | Zeichenfolge | Name des Kubernetes Secret, das die AWS-Anmeldeinformationen enthält 
|===
...
Eine vollständige Liste der Backend-Parameter finden Sie unter: xref:trident-use/trident-fsx-storage-backend.adoc#backend-advanced-configuration-and-examples[FSx für NetApp ONTAP Backend-Konfiguration].
