...
* OpenShift 4.14 – 4.19 (Wenn Sie die iSCSI-Knotenvorbereitung mit OpenShift 4.19 verwenden möchten, wird mindestens die Trident Version 25.06.1 unterstützt.)
