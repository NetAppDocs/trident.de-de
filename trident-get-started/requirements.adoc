...
* Lokale FAS, AFF oder ASA r2-Clusterversionen (iSCSI, NVMe/TCP und FC) unterliegen dem eingeschränkten Support von NetApp. Sehenlink:https://mysupport.netapp.com/site/info/version-support["Unterstützung Der Softwareversion"] .
