...
* Lokale FAS, AFF oder ASA r2-Systeme (iSCSI, NVMe/TCP und FC) mit ONTAP Versionen unter vollständiger oder eingeschränkter NetApp Unterstützung. Sehen link:https://mysupport.netapp.com/site/info/version-support["Unterstützung Der Softwareversion"]Die
