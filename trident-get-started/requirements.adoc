...
NOTE: Diese Konfiguration funktionierte in früheren Versionen, aber die vollständige Qualifizierung beginnt mit 26.06.
...
| Kubernetes (Infrastruktur und Gast-Cluster) | 1,36 


| KubeVirt | 1.9.0-beta.0 


| Containerisierter Datenimporteur (CDI) | 1,65 
|===
.Zu berücksichtigende Aspekte:
...
=== Für Trident 26.06 werden Container-Images benötigt.
