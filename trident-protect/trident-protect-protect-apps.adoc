...
| protect.trident.netapp.io/volume-snapshots-ready-to-use-timeout | Zeichenfolge | Die maximal zulässige Zeitspanne, bis Volume-Snapshots den einsatzbereiten Zustand erreichen. | "30m" 
