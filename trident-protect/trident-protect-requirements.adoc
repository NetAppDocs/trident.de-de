...
* Stellen Sie sicher, dass mindestens eine VolumeSnapshotClass existiert. Weitere Informationen finden Sie unter link:https://docs.netapp.com/us-en/trident/trident-reference/objects.html#kubernetes-volumesnapshotclass-objects["VolumeSnapshotKlasse"].
...
----
====
Wie Anwendungen definiert und VMs mit Trident Protect wiederhergestellt werden, ist unter link:trident-protect-kubevirt-vms.html["Schutz von KubeVirt virtuellen Maschinen mit Trident Protect"] beschrieben.
