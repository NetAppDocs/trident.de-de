...
NOTE: Die Skripte im Verda-Repository werden wie besehen bereitgestellt und sind nicht offiziell von NetApp unterstützt. NetApp-Support umfasst ausschließlich das Execution Hooks Framework innerhalb von Trident Protect.
