...
* Dem ANF-Treiber wurde die manuelle QoS-Unterstützung hinzugefügt, wodurch er in Trident 26.02 produktionsreif ist; diese experimentelle Erweiterung wurde in Trident 25.06 eingeführt.
