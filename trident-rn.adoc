...
* Die Unterstützung für Parallelverarbeitung für ONTAP-NAS (nur NFS), ONTAP-SAN (iSCSI, FCP, NVMe) und Google Cloud NetApp Volumes-Treiber ist jetzt allgemein verfügbar (GA).
* Unterstützung für die automatische Backend-Konfiguration für Amazon FSx for NetApp ONTAP hinzugefügt. Wenn Sie eine StorageClass erstellen, die die erforderlichen Parameter enthält, erstellt NetApp Trident automatisch das entsprechende Backend und die VolumeSnapshotClass (falls erforderlich).
* Es wurde Unterstützung für verschiedene Microsoft Azure-Clouds hinzugefügt, wie Azure Government und Azure China, sowie eine benutzerdefinierte Cloud-Konfiguration für Azure NetApp Files Backends.
* Verbesserte Controller-Skalierbarkeit für NVMe-Volumes.
* Unterstützung für die automatische Volumenvergrößerung wurde hinzugefügt. Sie können das Verhalten der automatischen Vergrößerung steuern, indem Sie benutzerdefinierte NetApp Trident autogrow-Richtlinien definieren.
* Unterstützung für Google Cloud NetApp Volumes Blockspeicher (SAN/iSCSI) hinzugefügt.
* Unterstützung für automatisches Tiering für Google Cloud NetApp Volumes hinzugefügt. Sie können die Speicherkosten jetzt optimieren, indem Sie Kubernetes-native Steuerelemente hinzufügen, um das ONTAP FabricPool Auto-Tiering für Google Cloud NetApp Volumes über NetApp Trident zu konfigurieren.
* Unterstützung für Kubernetes 1.35 hinzugefügt.
