...
== Was ist neu in 25.02

Ab Trident 25.02 enthält die neue Zusammenfassung Informationen zu Verbesserungen, Fixes und Korrekturen für Trident und Trident Protect Versionen.
...
** Automatische Backend-Konfiguration für EKS Add-on und Helm-basierte Installation für Amazon FSX for NetApp ONTAP hinzugefügt.
...
** Zusätzliche Unterstützung für OpenShift-Virtualisierung für ONTAP-Treiber.
...
* Backup- und Wiederherstellungsunterstützung für KubeVirt/OpenShift-Virtualisierungs-VMs für Volumes-Modus: Datei- und VolumeModus: Block (RAW Device)-Speicher zur bereits verfügbaren Speicherreplikation über AppMirrorRelationship.
