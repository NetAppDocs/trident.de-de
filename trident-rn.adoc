...
* Behoben wurde ein Fehler, bei dem KubeVirt-Virtuelle-Maschinen-Anwendungen PersistentVolumeClaims während AppMirrorRelationship-Reverse-, Reverse-Resync- und Resync-Operationen fälschlicherweise neu erstellt haben.
